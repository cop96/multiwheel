        ...
        <div class="prose prose-lg max-w-none">
            ...
            <div class="bg-workshop-white p-6 rounded-lg mb-4">
                ...
                <div class="border-t pt-3">
                    <p class="text-sm text-steel-gray"><strong>Finalidad:</strong>保证网站的正常运行和基本功能</p>
                    <p class="text-sm text-steel-gray"><strong>DuraciÃ³n:</strong>Sesión o persistente (hasta 1 año)</p>
            ...
            <div class="bg-workshop-white p-6 rounded-lg mb-4">
                ...
                <div class="border-t pt-3">
                    <p class="text-sm text-steel-gray"><strong>Finalidad:</strong>改善网站性能和用户体验</p>
                    <p class="text-sm text-steel-gray"><strong>DuraciÃ³n:</strong>Hasta 2 años</p>
            ...
            <div class="bg-workshop-white p-6 rounded-lg mb-4">
                ...
                <div class="border-t pt-3">
                    <p class="text-sm text-steel-gray"><strong>Finalidad:</strong>记住用户偏好设置</p>
                    <p class="text-sm text-steel-gray"><strong>DuraciÃ³n:</strong>Hasta 1 año</p>
                    <p class="text-sm text-steel-gray"><strong>Propia/Terceros:</strong>Propia</p>
                </div>
            </div>
            ...
            <table class="w-full border-collapse mb-6">
                <thead>
                    <tr class="bg-multiwheel-blue text-white">
                        ...
                        <th class="px-4 py-3 text-left">Finalidad</th>
                        <th class="px-4 py-3 text-left">Política</th>
                    </tr>
                </thead>
                <tbody class="bg-workshop-white">
                    <tr class="border-b">
