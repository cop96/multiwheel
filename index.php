...
<section class="relative min-h-[600px] md:min-h-[700px] flex items-center overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        <img src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=1920&q=80"
            alt="Interior de furgoneta equipada profesionalmente" class="w-full h-full object-cover">
    </div>
    ...
    <div class="relative z-20 container mx-auto px-4">
        <div class="max-w-2xl">
            <!-- Pretitle -->
            <p
                class="text-multiwheel-orange font-semibold uppercase tracking-wider text-sm mb-4 flex items-center gap-2">
            ...
            <p class="text-xl text-gray-200 leading-relaxed mb-8">
                Equipamiento profesional para talleres móviles, reparación especializada de grúas y sistemas de rescate
                en carretera.
            ...
            <div class="flex flex-wrap gap-4 mb-10">
                <a href="catalogo.php"
                    class="bg-multiwheel-red hover:bg-red-700 text-white px-6 py-3 rounded font-semibold transition flex items-center gap-2">
                    <i class="fas fa-box-open"></i>
                    Ver catálogo de equipamiento
                </a>
                <a href="contacto.php"
                    class="border-2 border-white hover:bg-white hover:text-multiwheel-blue text-white px-6 py-3 rounded font-semibold transition flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-workshop-white p-8 rounded-lg hover:shadow-xl transition duration-300">
                ...
                <p class="text-industrial-gray">
                    Diseñamos el equipamiento según tu actividad profesional: electricistas, fontaneros, herreros,
                    servicios de grúa.
...
<section class="py-16 md:py-24 bg-workshop-white">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition duration-300 group">
                <div class="relative h-64 overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?auto=format&fit=crop&q=80&w=800"
                        alt="Grúa de auxílio en carretera profesional"
                ...
                <div class="p-6">
                    ...
                    <p class="text-industrial-gray mb-4">
                        Sistemas de rescate certificados, reparación de plumas hidráulicas, compra-venta de carrocerías
                        usadas
                    ...
                    <a href="servicios.php#gruas"
                        class="inline-flex items-center gap-2 text-multiwheel-red hover:text-red-700 font-semibold transition">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition duration-300 group">
                <div class="relative h-64 overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&q=80&w=800"
                        alt="Taller móvil profesional equipado"
                        class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                    <div class="absolute top-4 left-4">
                ...
                <div class="p-6">
                    ...
                    <p class="text-industrial-gray mb-4">
                        Estanterías modulares, generadores autónomos, iluminación LED profesional y suelos
                        antideslizantes.
                    ...
                    <a href="servicios.php#taller-movil"
                        class="inline-flex items-center gap-2 text-multiwheel-orange hover:text-orange-700 font-semibold transition">
                        Ver detalles del servicio
                        <i class="fas fa-arrow-right"></i>
                    </a>
                </div>
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition duration-300 group">
                ...
                <div class="p-6">
                    ...
                    <a href="servicios.php#transporte"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white/10 backdrop-blur-sm border border-white/20 p-6 rounded-lg">
                <div class="flex items-center gap-4 mb-4">
                    <img src="https://i.pravatar.cc/80?img=12" alt="José M. Ramírez"
            ...
            <div class="bg-white/10 backdrop-blur-sm border border-white/20 p-6 rounded-lg">
                <div class="flex items-center gap-4 mb-4">
                    <img src="https://i.pravatar.cc/80?img=33" alt="Grúas Hermanos López"
                        class="w-16 h-16 rounded-full border-2 border-multiwheel-orange">
                    <div>
