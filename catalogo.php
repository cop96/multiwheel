...
<section class="py-16 md:py-24 bg-white">
    <div class="container mx-auto px-4">
        ...
        <div class="flex flex-wrap justify-center gap-2 mb-12">
            ...
            <button
                class="px-4 py-2 bg-workshop-white text-industrial-gray hover:bg-multiwheel-blue hover:text-white rounded-full font-semibold transition">
                Estanterías
            </button>
            <button
                class="px-4 py-2 bg-workshop-white text-industrial-gray hover:bg-multiwheel-blue hover:text-white rounded-full font-semibold transition">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            foreach ($productos as $p):
                ...
                <div
                    ...
                    <div class="p-4">
                        <p class="text-xs text-steel-gray mb-1">REF: <?php echo $p['id']; ?></p>
                            ...
                            <ul class="space-y-1 mb-4">
                                ...
                                foreach ($p['especificaciones'] as $key => $val):
                                    ...
                                    <li class="flex items-center gap-1 text-xs text-industrial-gray truncate">
                                        ...
                                        <span class="font-semibold capitalize"><?php echo $key; ?>:</span> <?php echo $val; ?>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        <?php endif; ?>
