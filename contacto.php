...
<section class="bg-multiwheel-blue py-16 md:py-24">
    <div class="container mx-auto px-4 text-center">
        ...
        <div class="mt-8 max-w-2xl mx-auto p-4 bg-green-100 text-green-800 rounded-lg border border-green-200">
            <i class="fas fa-check-circle mr-2"></i> ¡Mensaje enviado con éxito! Nos pondremos en contacto pronto.
        </div>
        <?php
elseif (isset($_GET['mensaje']) && $_GET['mensaje'] === 'error'): ?>
        <div class="mt-8 max-w-2xl mx-auto p-4 bg-red-100 text-red-800 rounded-lg border border-red-200">
            <i class="fas fa-exclamation-triangle mr-2"></i> Hubo un error al enviar el mensaje. Por favor, inténtalo de
            nuevo o llámanos.
        </div>
        <?php
endif; ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
                ...
                <div class="flex items-start gap-4 mb-6 p-4 bg-workshop-white rounded-lg">
                    <div
                        class="flex-shrink-0 w-12 h-12 bg-multiwheel-blue/10 rounded-full flex items-center justify-center">
                    ...
                    <div>
                        ...
                        <p class="text-industrial-gray">
                            <a href="https://wa.me/34620531511" target="_blank"
                                class="hover:text-green-600 transition font-semibold">
                                620 531 511
                            </a>
                        </p>
                ...
                <div class="flex flex-wrap gap-3 mt-8">
                    <a href="tel:+34620531511"
                        class="flex-1 min-w-[150px] bg-multiwheel-red hover:bg-red-700 text-white py-3 px-4 rounded font-semibold transition text-center">
                        <i class="fas fa-phone mr-2"></i>Llamar
                    </a>
                    <a href="https://wa.me/34620531511" target="_blank"
                        class="flex-1 min-w-[150px] bg-green-600 hover:bg-green-700 text-white py-3 px-4 rounded font-semibold transition text-center">
            ...
            <div>
                ...
                <form class="space-y-4" action="enviar-contacto.php" method="POST">
                    <!-- Nombre -->
                    <div>
                    ...
                    <div class="flex items-start gap-2">
                        ...
                        <label for="privacidad" class="text-sm text-steel-gray">
                            He leído y acepto la <a href="politica-privacidad.php"
                                class="text-multiwheel-blue hover:underline">Política de Privacidad</a>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="bg-white rounded-lg overflow-hidden shadow-lg">
            <iframe
                ...
                referrerpolicy="no-referrer-when-downgrade" class="w-full h-[400px]">
            </iframe>
        </div>
    </div>
</section>
