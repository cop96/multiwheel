...
<head>
    ...
    <style>
        ...
        h1, h2, h3, .brand-text { font-family: 'Rajdhani', sans-serif; }
        
        @media print {
            .no-print { display: none; }
            body { padding: 0; background: white; }
            .page-break { page-break-after: always; }
            .catalog-container { width: 100% !important; max-width: none !important; margin: 0 !important; padding: 0 !important; }
            .product-sheet { box-shadow: none !important; border: none !important; margin: 0 !important; padding: 1.5cm !important; }
        }
        ...
        .bg-multiwheel-blue { background-color: #1e3a5f; }
        .text-multiwheel-blue { color: #1e3a5f; }
        .text-multiwheel-orange { color: #f05a28; }
    </style>
</head>
<body class="py-8">
    ...
    <div class="no-print fixed top-6 right-6 z-50 flex flex-col gap-3">
        <button onclick="window.print()" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full shadow-2xl font-bold transition flex items-center gap-2">
            <i class="fas fa-print text-xl"></i> IMPRIMIR / GUARDAR TODO EL CATÁLOGO
        </button>
        <a href="catalogo.php" class="bg-white hover:bg-gray-100 text-multiwheel-blue px-6 py-3 rounded-full shadow-lg font-bold transition text-center border border-gray-200">
    ...
    <div class="catalog-container container mx-auto max-w-5xl px-4">
        ...
        <!-- COVER PAGE -->
        <div class="product-sheet page-break flex flex-col items-center justify-center bg-multiwheel-blue text-white text-center">
        ...
        <?php 
        $current_cat = '';
        foreach ($products_data['productos'] as $index => $producto): 
            // New Category Page
            if ($producto['categoria'] !== $current_cat):
                $current_cat = $producto['categoria'];
                $cat_name = $producto['categoria_display'] ?? 'Accesorios';
        ?>
            <div class="product-sheet page-break flex flex-col items-center justify-center bg-gray-50 border-l-8 border-multiwheel-orange text-center">
                <div class="mb-8 opacity-40">
                    <img src="logo550_nuevo.png" alt="Multiwheel" class="w-32">
                </div>
                <p class="text-multiwheel-orange font-bold tracking-widest mb-4">SECCIÓN</p>
                <h2 class="text-5xl font-bold text-multiwheel-blue uppercase"><?php echo $cat_name; ?></h2>
                <div class="w-24 h-1 bg-multiwheel-orange mt-8 mx-auto"></div>
            </div>
        <?php endif; ?>

            <div class="product-sheet page-break">
        ...
        <div class="product-sheet flex flex-col items-center justify-center bg-multiwheel-blue text-white text-center">
            ...
            <p class="text-xl opacity-80 mb-12">Contacte con nosotros para presupuestos a medida y asesoramiento técnico.</p>
