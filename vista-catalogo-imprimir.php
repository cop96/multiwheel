...
?>
        <div
            class="product-sheet page-break flex flex-col items-center justify-center bg-gray-50 border-l-8 border-multiwheel-orange text-center">
            ...
            <h2 class="text-5xl font-bold text-multiwheel-blue uppercase">
                <?php echo $cat_name; ?>
            </h2>
